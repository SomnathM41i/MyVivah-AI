...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Where public contact-form submissions (phase-5a) and support enquiries
    | are delivered. No default domain-specific value so misconfigured envs fail
    | loudly in tests rather than emailing strangers.
    |
    */

    'to' => [
        'address' => env('MAIL_TO_ADDRESS'),
        'name' => env('MAIL_TO_NAME', env('APP_NAME', 'MyVivahAI')),
    ],
